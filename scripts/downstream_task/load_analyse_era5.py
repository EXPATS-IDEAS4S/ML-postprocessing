...
from scripts.downstream_task.era5_load_utils import load_era5
from scripts.downstream_task.era5_plot_utils import (
    plot_distribution,
...
if __name__ == "__main__":
    ...
    dataset_mode = True  # if True → group distributions by frames
    vertical_profile_flag = False  # if True → plot vertical profile
    n_frame = 8
    ml_mode = "supervised"
    dataset = "val"
    variable_to_analyze = "tcc"
    ...
    for df_cat, cat_name in zip(df_list, category_names):
        ...
        if vertical_profile_flag and era_type == "pressure_levels":
            # Build dict by level
            data_by_level = {
