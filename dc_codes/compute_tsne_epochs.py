...
for epoch in epochs:
    for scale in scales:
        for random_state in random_states:
            ...
            np.save(f'{output_path}tsne_pca_cosine_perp-{perplexity}_{scale}_{random_state}_epoch_{epoch}.npy', embedding_pca_cosine)  ##

            print(f'{output_path}tsne_pca_cosine_perp-{perplexity}_{scale}_{random_state}_{epoch}.npy calculated and saved')
