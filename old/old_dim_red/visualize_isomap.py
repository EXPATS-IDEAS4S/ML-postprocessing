...
output_path = '/home/Daniele/fig/dcv_ir108_128x128_k9_30k_grey_min-max/'

tsne_path = '/home/Daniele/fig/dcv_ir108_128x128_k9_30k_grey_min-max/'
...
image_path = '/home/Daniele/data/ir108_2013-2014_RGB_min-max/1/' #cot_2013_128_germany, ir108_2013_128_germany
...
path_feature = '/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/features/'

checkpoints_path = '/home/Daniele/codes/vissl/runs/dcv2_ir108_128x128_k9_germany_30kcrops_grey_min-max/checkpoints/'  
...
df_subset = pd.merge(df, df_labels, left_on='Selected_Index', right_on='index', how='left')
...
indices = df_conc.Selected_Index.tolist()
print(indices)
...
for i,index in enumerate(indices):
    ...
    label = df_conc.loc[df_conc['Selected_Index'] == index, 'y'].item()
    y=df_conc.loc[df_conc['Selected_Index'] == index,'Component_1'].item()
    x=df_conc.loc[df_conc['Selected_Index'] == index,'Component_2'].item()
