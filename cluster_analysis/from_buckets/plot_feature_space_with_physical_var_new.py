...
from feature_space_plot_functions import name_to_rgb, colors_per_class1_names
...
for class_label in df_merged['label'].unique():
    ...
    output_file = f"{output_path}{run_name}_class_{int(class_label)}_{variable}_plot.png"
